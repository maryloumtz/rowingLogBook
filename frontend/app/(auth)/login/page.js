...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-foam px-4">
      <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-panel ring-1 ring-ink/5">
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
          ...
          <button
            ...
            className="w-full rounded-xl bg-surge py-2.5 text-sm font-semibold text-white transition hover:bg-surge/90 disabled:opacity-50"
          >
